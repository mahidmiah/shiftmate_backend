...
const weekSchema = new mongoose_1.default.Schema({
    businessID: String,
    weekNumber: Number,
    year: Number,
...
const WeekModel = mongoose_1.default.models.Week || mongoose_1.default.model('Week', weekSchema);
exports.default = WeekModel;
